...
# persona → (domain, scope_tags) derivation is shared engine code
# (engram.profiles) so every integration resolves personas identically.
from engram.profiles import derive_profile  # noqa: E402
